...
public class EditarDetalleActividad extends AppCompatActivity {
    ...
    EditText idDetalle;
    EditText grupo,idActividad,idLocal,descripcionActividad;
    ...
    public void consultarDetalleActividad(View v){
        ...
        if(id_detalle == null){
            ...
            if(detalle == null){
                ...
                idDetalle.setText(String.valueOf(detalle.getID_DETALLE()));
    ...
    public void actualizarDetalleActividad(View v){
        ...
        if(id_detalle.isEmpty() || grupo1.isEmpty() || id_Actividad.isEmpty() || id_local.isEmpty() || descripAct.isEmpty()){
