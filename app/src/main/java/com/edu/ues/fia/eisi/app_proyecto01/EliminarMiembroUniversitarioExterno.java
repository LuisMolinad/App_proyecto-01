...
@SuppressLint("NewApi")
public class EliminarMiembroUniversitarioExterno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eliminar_miembro_universitario_externo);
    ...
    public void eliminarMiembroUniversitario(View v){
        ...
        if(idMiembroUniversitario.getText().toString().isEmpty()){
